...
export class QzPrintService {
   ...
   * convertida a blanco/negro puro (ver ReciboService.imprimir()). Se dejó de
   * mandar el cuerpo como texto ESC/POS línea por línea: esta impresora
   * imprimía el texto con muy poca densidad de tinta térmica (se veía
   * gris/débil) incluso con negrita forzada, mientras que las imágenes (como
   * el logo) siempre salían sólidas — por eso ahora todo el recibo se manda
   * como una sola imagen, igual que el logo.
   */
